...
import {
  messagePartSchema, messagePartsSchema, type SupportedChatModelId,
} from "@filiks/shared";
...
import { MessageStatus } from "@filiks/database/enums";
...
function SessionChat({ session} : {session: SessionData}) {
  ...
  return(
    <SessionShell
      ...
      parts={streaming.status === "streaming" ? streaming.parts : []}
      session={{ title: session.title, createdAt: session.createdAt, cwd: session.cwd }}
    >
      {messages.map((msg) => (
